...
export default function Callout({ type, title, children }: CalloutProps) {
  return (
    <div className={`blog-callout blog-callout-${type}`}>
      <div className="blog-callout-icon">{CALLOUT_ICONS[type]}</div>
      <div className="blog-callout-content">
        <div className="blog-callout-title">{title || CALLOUT_TITLES[type]}</div>
        <div className="blog-callout-text">{children}</div>
      </div>
    </div>
  );
}
